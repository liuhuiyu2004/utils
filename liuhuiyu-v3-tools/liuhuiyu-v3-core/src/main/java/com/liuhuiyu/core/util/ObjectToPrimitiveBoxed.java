...
/**
 * 将 Object 转换成 基本类型封装型<p>
 * Created on 2025/4/6 21:43
 *
 * @author liuhuiyu
 * @version 1.0
 * @since 21
...
//region 数据类型
    ...
    static {
        ...
        DATA_TYPE_MAP.put(byte[].class.getName(), byte[].class.getName());
        DATA_TYPE_MAP.put(Byte[].class.getName(), byte[].class.getName());
        DATA_TYPE_MAP.put(java.sql.Date.class.getName(), java.sql.Date.class.getName());
    }
    ...
    static {
        ...
        LOCAL_DATE_TIME_MAP.put(java.sql.Date.class.getName(), (value) -> {
