...
public class ResultFeignDecoder implements Decoder {
    ...
    public Object decode(Response response, Type type) throws IOException, FeignException {
        ...
        //对结果进行转换
        final Map<String, Object> map = GsonUtil.mapOfJsonString(bodyStr);
        ...
        if (result.isSuccess()) {
            ...
            if (type.getTypeName().contains(PAGE_IMPL_CLASS_NAME)) {
                ...
                // 获取数据结果集
                List<Object> content;
                if (dataMap.get(PAGE_IMPL_CONTENT_FIELD_NAME) instanceof Collection<?> list) {
