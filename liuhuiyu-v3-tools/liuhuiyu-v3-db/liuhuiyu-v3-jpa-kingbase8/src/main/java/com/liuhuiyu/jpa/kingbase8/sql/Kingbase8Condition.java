 ...
 */
public class Kingbase8Condition<T> implements Condition<T, Kingbase8Condition<T>> {

    public Kingbase8Condition(AbstractSqlCommandPackageKingbase8<T> sqlCommandPackage) {
        this.sqlCommandPackage = sqlCommandPackage;
    }

    final AbstractSqlCommandPackageKingbase8<T> sqlCommandPackage;
    String fieldName;
    String minFieldName;
    String maxFieldName;
    String condition;

    public AbstractSqlCommandPackageKingbase8<T> getSqlCommandPackage() {
     ...
     */
    @Override
    public AbstractSqlCommandPackage<T, Kingbase8Condition<T>> likeValue(String value) {
     ...
     */
    @Override
    public AbstractSqlCommandPackage<T, Kingbase8Condition<T>> likeValue(String value, Boolean trim, Boolean head, Boolean tail) {
        this.checkField();
     ...
     */
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> inPackage(P[] data) {
     ...
     */
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> inPackage(Collection<P> collection) {
        return inPackage(collection, false, false);
    }

    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> inPackage(Collection<P> collection, Boolean notIn, Boolean isNull) {
        this.checkField();
     ...
     */
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> inPackage(P[] data, Boolean notIn, Boolean isNull) {
        this.checkField();
    ...
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> between(P beginValue, P endValue) {
        this.checkField();
     ...
     */
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> inclusion(P minValue, P maxValue) {
        this.checkField2();
     ...
     */
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> eq(P value) {
     ...
     */
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> ne(P value) {
        return this.generate("<>", value);
    }
     ...
     */
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> gt(P value) {
        return this.generate(">", value);
    }
     ...
     */
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> lt(P value) {
        return this.generate("<", value);
    }
     ...
     */
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> ge(P value) {
        return this.generate(">=", value);
    }
     ...
     */
    @Override
    public <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> le(P value) {
        return this.generate("<=", value);
    }
     ...
     */
    @Override
    public AbstractSqlCommandPackage<T, Kingbase8Condition<T>> isNull() {
        this.checkField();
     ...
     */
    @Override
    public AbstractSqlCommandPackage<T, Kingbase8Condition<T>> isNotNull() {
        this.checkField();
        this.sqlCommandPackage.getSelectSql().getSqlWhere()
                .append(condition)
                .append("(").append(this.fieldName)
    ...
    @Override
    public AbstractSqlCommandPackage<T, Kingbase8Condition<T>> expression(String expression) {
        this.sqlCommandPackage.getSelectSql().getSqlWhere()
    ...
    @Override
    public AbstractSqlCommandPackage<T, Kingbase8Condition<T>> child(String operator, SelectSql value) {
        return null;
    }

    private <P> AbstractSqlCommandPackage<T, Kingbase8Condition<T>> generate(String operator, P value) {
        this.checkField();
        if (value != null) {
            this.sqlCommandPackage.getSelectSql().getSqlWhere()
                    .append(condition)
