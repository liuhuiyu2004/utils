...
public class SelectSql implements Serializable {
    ...
    public Condition conditionAnd(String fieldName) {
        return new Condition(this, "AND", fieldName);
    }
    public Condition conditionOr(String fieldName) {
        return new Condition(this, "OR", fieldName);
    }
}
