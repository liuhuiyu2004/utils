package com.liuhuiyu.demo.domain;

import com.liuhuiyu.demo.db.DbServerConstant;
 ...
 */
@MappedSuperclass
public class BaseAccountOperate implements DbServerConstant {
    ...
    private Integer creatorTypeId;
    @Column(columnDefinition = NVARCHAR + " (" + COLUMN_DEFAULT_FIELD_MAX_LENGTH + ")")
    @Comment("创建人名称")
    ...
    public void createOperate(IOperating operator) {
    ...
    public void updateOperate(IOperating operator) {
    ...
    public void deleteOperate(IOperating operator) {
